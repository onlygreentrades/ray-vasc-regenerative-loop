...
This update documents the originating RAY-001 baseline characterization and timing-window case as a root-level OSF component and GitHub manuscript folder. The manuscript documents baseline phenotype, data availability, missingness, Tier 1/Tier 2 feasibility constraints, and the operational lesson that caregiver-supported Tier 1 capture should begin before Tier 2 EEG/biomarker readiness delays the clinical window.

Updated root navigation and governance files to reflect the completed three-paper publication triad:

- Paper 1: framework / residual-capacity thesis.
- Paper 2: RAY-VASC protocol spine with public OSF DOI.
- Paper 3: RAY-001 baseline characterization and timing-window case with no intervention outcomes.
...
- Confirmed Paper 2 final assets under `manuscripts/paper2/final/`.
- Confirmed Paper 2 supplementary materials under `supplements/paper2/final/`.
...
- Paper 2 supplementary checklist, schedules, data dictionary, and adverse-event template.
